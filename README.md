...
| Релиз | _Описание_ | Ссылки на скачивание |
| :---         |     :---:      |          ---: |
| **Ветер Времени OGSR Edition** | _[**Ветер Времени**](https://www.moddb.com/mods/wind-of-time) — один из самых популярных и узнаваемых модов в комьюнити. Это сюжетный проект, созданный одним человеком в далеком 2017 году. Мы выбрали этот мод для тестирования CoP-версии OGSR Engine, и результаты превзошли все ожидания. Для меня, как человека, который раньше не играл в этот мод, он выглядит значительно лучше, чем большинство модов последних лет, которые выходили на базе Зова Припяти. Именно поэтому я решил выпустить автономную версию мода на базе OGSR Engine, чтобы любой желающий мог перепройти этот замечательный мод на новом движке._ | [**WOT 1.3+ OGSR Edition**](https://github.com/OGSR/OGSR_Releases/releases/tag/WOT1.3%2BOGSR_Edition) |
